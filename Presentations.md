You work with labmates who know absolutely nothing about UNIX commands and high-performance computing, so they rely on you to explain some basic concepts and demonstrate basic skills. Your job is to prepare a **2-minute presentation** explaining a topic (see ideas for topics, below) using these guidelines:
