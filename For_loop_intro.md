...
Now open nano (<a href="https://github.com/jamiehenzy/Genome-analysis_UNIX_HPC/blob/main/1_UNIX.md#u28-fire-the-editor">see U28 of the first UNIX tutorial</a>) and add as the first line:
