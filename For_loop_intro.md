...
Now open nano (<a href="https://github.com/jamiehenzy/Genome-analysis_UNIX_HPC/blob/main/1_UNIX.md#u28-fire-the-editor">see</a> if you need a refresher) and add as the first line:
